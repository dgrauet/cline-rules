---
name: "Task Handoff Strategy Guide"
description: "MANDATORY instructions for effective task management, context preservation, and smooth transitions between tasks"
author: "https://github.com/cline"
version: "2.0"
tags: ["context-management", "task-automation", "workflow", "best-practices"]
globs: ["*"]
related_rules: ["baby-steps.md"]
...
### Depends On
- **[Baby Steps™ Methodology](baby-steps.md)** - Core principles that govern all task execution and handoff processes

### Extends
- **Task Management Framework**: Provides specific implementation details for managing task transitions while maintaining Baby Steps principles

### See Also
- **[TODO Implementation Guidelines](TODO-implementation.md)** - Workspace-specific implementation details for progress tracking during task handoffs

### Replaces
Version 1.0 of task handoff automation - updated with enhanced context preservation and comprehensive handoff procedures
